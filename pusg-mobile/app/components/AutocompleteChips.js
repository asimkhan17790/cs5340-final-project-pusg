...
export default class AutocompleteChips extends Component {
  static defaultProps = {
    onChipClose: () => {},
    onSubmitEditing: () => {}
  };
  ...
  validate = email => {
    ...
    if (this.getSelectedEmails().length >= 10 && this._childEmailField.state.text) {
      this.setState({ error: 'Sorry, you can enter a maximum of 10 members' });
      ...
      <View>
        <ChildEmailField
          ...
          textInputProps={{
            ...
            placeholder: 'Insert one or more name',
